...
return [
    ...
    'bundles'                                   => [
        ...
        'tour_legs' => [
            ...
            'unsaved'   => "Number this bundle's flights from 1 with no gaps. Save the bundle to check its current legs.",
        ],
        'fields' => [
            'name'              => 'Name',
            'description'       => 'Description',
            'type'              => 'Type',
            'type_helper'       => 'A tour is bid as one ordered chain of legs. Its flights must be numbered 1 to N with no gaps.',
            'enabled'           => 'Enabled',
            'visible'           => 'Visible',
