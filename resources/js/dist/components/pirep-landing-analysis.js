...
var na = (i, t, e) =>
  t in i ? sa(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (i[t] = e);
var M = (i, t, e) => na(i, typeof t != "symbol" ? t + "" : t, e);
function ve(i) {
  return (i + 0.5) | 0;
}
...
var nt = {
  ...
  Ci = [..."0123456789ABCDEF"],
  oa = (i) => Ci[i & 15],
  aa = (i) => Ci[(i & 240) >> 4] + Ci[i & 15],
  Ue = (i) => (i & 240) >> 4 === (i & 15),
  ra = (i) => Ue(i.r) && Ue(i.g) && Ue(i.b) && Ue(i.a);
function la(i) {
  var t = i.length,
    e;
  return (
...
var ca = (i, t) => (i < 255 ? t(i) : "");
function ha(i) {
  var t = ra(i) ? oa : aa;
  return i ? "#" + t(i.r) + t(i.g) + t(i.b) + ca(i.a, t) : void 0;
}
var da =
...
function ba(i) {
  ...
  let n = js(+t[2]),
    ...
    a = +t[4] / 100;
  return (
    t[1] === "hwb" ? (s = pa(n, o, a)) : t[1] === "hsv" ? (s = ma(n, o, a)) : (s = Ri(n, o, a)),
    { r: s[0], g: s[1], b: s[2], a: e }
  );
}
function xa(i, t) {
  var e = Ti(i);
  ((e[0] = js(e[0] + t)), (e = Ri(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]));
}
function _a(i) {
  if (!i) return;
  let t = Ti(i),
...
function ya() {
  ...
  for (s = 0; s < t.length; s++) {
    for (a = r = t[s], n = 0; n < e.length; n++) ((o = e[n]), (r = r.replace(o, Ws[o])));
...
var Xe;
function va(i) {
  Xe || ((Xe = ya()), (Xe.transparent = [0, 0, 0, 0]));
...
var Ai = (i) => (i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055),
...
function Sa(i, t, e) {
  let s = qt(mt(i.r)),
    ...
    o = qt(mt(i.b));
  return {
    r: St(Ai(s + e * (qt(mt(t.r)) - s))),
    g: St(Ai(n + e * (qt(mt(t.g)) - n))),
    b: St(Ai(o + e * (qt(mt(t.b)) - o))),
    a: i.a + e * (t.a - i.a),
  };
}
function Ke(i, t, e) {
...
function Ns(i) {
  ...
  return (
    Array.isArray(i)
      ...
      : ((t = $s(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = St(t.a))),
    t
  );
}
function Pa(i) {
  return i.charAt(0) === "r" ? ka(i) : ba(i);
}
var ye = class i {
  constructor(t) {
    ...
    let e = typeof t,
      s;
    (e === "object" ? (s = Ns(t)) : e === "string" && (s = la(t) || va(t) || Pa(t)),
      (this._rgb = s),
      (this._valid = !!s));
  }
  get valid() {
  ...
  interpolate(t, e) {
    return (t && (this._rgb = Sa(this._rgb, t._rgb, e)), this);
  }
  clone() {
...
var sn = (i, t) => (typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 : +i / t),
...
var oi = (i) => (i === "start" ? "left" : i === "end" ? "right" : "center"),
  ...
  gn = (i, t, e, s) => (i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t);
function Xi(i, t, e) {
  let s = t.length,
    n = 0,
    o = s;
  if (i._sorted) {
    ...
    if (g) {
      ...
      if (c) {
        let m = l.slice(p - 1).findIndex((b) => !C(b[r.axis]));
        p += Math.max(0, m);
      }
      o = Y(p, n, s) - n;
    } else o = s - n;
...
var Ge = (i) => i === 0 || i === 1,
  Xs = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * B) / e)),
  Ks = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * B) / e) + 1,
  Jt = {
    linear: (i) => i,
    easeInQuad: (i) => i * i,
    easeOutQuad: (i) => -i * (i - 2),
    ...
    easeInElastic: (i) => (Ge(i) ? i : Xs(i, 0.075, 0.3)),
    easeOutElastic: (i) => (Ge(i) ? i : Ks(i, 0.075, 0.3)),
    easeInOutElastic(i) {
      return Ge(i)
        ? i
        : i < 0.5
          ? 0.5 * Xs(i * 2, 0.1125, 0.45)
          : 0.5 + 0.5 * Ks(i * 2 - 1, 0.1125, 0.45);
    },
    easeInBack(i) {
...
function qi(i) {
  return Gi(i) ? i : new ye(i);
}
function Ii(i) {
  return Gi(i) ? i : new ye(i).saturate(0.5).darken(0.1).hexString();
}
var Ea = ["x", "y", "borderWidth", "radius", "tension"],
  Fa = ["color", "borderColor", "backgroundColor"];
function za(i) {
  (i.set("animation", {
    delay: void 0,
    duration: 1e3,
    ...
    i.set("animations", {
      colors: { type: "color", properties: Fa },
      numbers: { type: "number", properties: Ea },
    }),
...
var Fi = class {
    constructor(t, e) {
      ((this.animation = void 0),
        ...
        (this.hover = {}),
        (this.hoverBackgroundColor = (s, n) => Ii(n.backgroundColor)),
        (this.hoverBorderColor = (s, n) => Ii(n.borderColor)),
        (this.hoverColor = (s, n) => Ii(n.color)),
        (this.indexAxis = "x"),
...
function ja(i, t) {
  (t.translation && i.translate(t.translation[0], t.translation[1]),
    C(t.rotation) || i.rotate(t.rotation),
...
function Ct(i, t, e, s, n, o = {}) {
  let a = z(t) ? t : [t],
    ...
    l,
    c;
  for (i.save(), i.font = n.string, ja(i, o), l = 0; l < a.length; ++l)
    ((c = a[l]),
      o.backdrop && Ya(i, o.backdrop),
      r &&
        (o.strokeColor && (i.strokeStyle = o.strokeColor),
        C(o.strokeWidth) || (i.lineWidth = o.strokeWidth),
...
var Ua = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
  Xa = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function Ka(i, t) {
  let e = ("" + i).match(Ua);
...
function Ja(i, t, e) {
  let { _proxy: s, _context: n, _subProxy: o, _descriptors: a } = i,
    r = s[t];
  return (
    bt(r) && a.isScriptable(t) && (r = Za(t, r, i, e)),
    z(r) && r.length && (r = Qa(t, r, i, a.isIndexable)),
...
var tr = (i, t) => (i === !0 ? t : typeof i == "string" ? _t(t, i) : void 0);
function er(i, t, e, s, n) {
  for (let o of t) {
    let a = tr(e, o);
    if (a) {
      i.add(a);
      let r = vn(a._fallback, e, n);
...
function is(i, t, e, s) {
  ...
  return l === null || (typeof o < "u" && o !== e && ((l = qs(r, a, o, l, s)), l === null))
    ? !1
    : ci(Array.from(r), [""], n, o, () => ir(t, e, s));
}
function qs(i, t, e, s, n) {
  for (; e; ) e = er(i, t, e, s, n);
  return e;
}
function ir(i, t, e) {
  let s = i._getTarget();
...
function sr(i, t, e, s) {
  let n;
  for (let o of t)
    if (((n = Mn(qa(o, i), e)), typeof n < "u")) return es(i, n) ? is(e, s, i, n) : n;
}
function Mn(i, t) {
  for (let e of t) {
    if (!e) continue;
...
function Js(i) {
  let t = i._keys;
  return (t || (t = i._keys = nr(i._scopes)), t);
}
function nr(i) {
  let t = new Set();
...
function wn(i, t, e, s, n) {
  ...
  if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone"))
    ...
    for (o = 0, a = i.length; o < a; ++o)
      ((r = i[o]),
        (l = ar(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
function An(i) {
  return i === "angle"
    ? { between: se, compare: Ia, normalize: X }
...
function ls(i, t, e) {
  ...
  let { property: s, start: n, end: o } = e,
    a = t.length,
    { compare: r, between: l, normalize: c } = An(s),
    { start: h, end: d, loop: u, style: f } = xr(i, t, e),
    g = [],
    p = !1,
    m = null,
    b,
    ...
    ((x = t[S % a]),
      !x.skip &&
        ...
        b !== v &&
          ...
          m !== null &&
            w() &&
            (g.push(Zs({ start: m, end: S, loop: u, count: a, style: f })), (m = null)),
          (P = S),
          (v = b))));
...
function Cn(i, t) {
  ...
  if (!n) return [];
  let o = !!i._loop,
    { start: a, end: r } = _r(e, n, o, s);
  if (s === !0) return Qs(i, [{ start: a, end: r, loop: o }], e, t);
  let l = r < a ? r + n : r,
    c = !!i._fullLoop && a === 0 && r === n - 1;
  return Qs(i, yr(e, a, l, c), e, t);
}
function Qs(i, t, e, s) {
...
function Mr(i, t) {
  ...
  let e = [],
    s = function (n, o) {
      return Gi(o) ? (e.includes(o) || e.push(o), e.indexOf(o)) : o;
    };
...
var Ms = class {
  ...
  ks = class {
    constructor(t, e, s, n) {
      ...
      let a = ae([t.from, o, n]);
      ((this._active = !0),
        (this._fn = t.fn || wr[t.type || typeof a]),
  ...
  vi = class {
    ...
    _animateOptions(t, e) {
      ...
      return (
        s.$shared &&
          Sr(t.options.$animations, s).then(
            () => {
              t.options = s;
            },
            () => {},
...
function En(i, t) {
  ...
  for (let f = 0; f < d; ++f) {
    ...
    ((u = b[c] = Lr(n, h, p)),
      (u[r] = m),
      (u._top = In(u, a, !0, s.type)),
      (u._bottom = In(u, a, !1, s.type)));
...
var fs = (i) => i === "reset" || i === "none",
  Fn = (i, t) => (t ? i : Object.assign({}, i)),
  Er = (i, t, e) => i && !t.hidden && t._stacked && { keys: To(e, !0), values: null },
  it = class {
    constructor(t, e) {
      ((this.chart = t),
        (this._ctx = t.ctx),
    ...
    _dataCheck() {
      ...
      if (T(e)) {
        ...
        (e && Object.isExtensible(e) && un(e, this), (this._syncList = []), (this._data = e));
      }
    }
    addElements() {
      let t = this._cachedMeta;
    ...
    applyStack(t, e, s) {
      let n = this.chart,
        o = this._cachedMeta,
        a = e[t.axis],
        r = { keys: To(n, !0), values: e._stacks[t.axis]._visualValues };
      return Rn(r, a, o.index, { mode: s });
    }
    ...
    _update(t) {
      ...
      (this.update(t || "default"),
        (e._clip = Or(D(this.options.clip, Dr(e.xScale, e.yScale, this.getMaxOverflow())))));
    }
    update(t) {}
    draw() {
      let t = this._ctx,
    ...
    getContext(t, e, s) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        ((o = a.$context || (a.$context = Ir(this.getContext(), t, a))),
          (o.parsed = this.getParsed(t)),
          (o.raw = n.data[t]),
          (o.index = o.dataIndex = t));
      } else
        ((o = this.$context || (this.$context = Rr(this.chart.getContext(), this.index))),
          (o.dataset = n),
    ...
    _resolveElementOptions(t, e = "default", s) {
      ...
      return (p.$shared && ((p.$shared = l), (o[a] = Object.freeze(Fn(p, l)))), p);
    }
...
function Br(i, t, e, s) {
  let n = e.barThickness,
    ...
    a;
  return (
    C(n) ? ((o = t.min * e.categoryPercentage), (a = e.barPercentage)) : ((o = n * s), (a = 1)),
...
function Lo(i, t, e, s) {
  return (z(i) ? Vr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t);
}
function zn(i, t, e, s) {
  let n = i.iScale,
    o = i.vScale,
    ...
    u;
  for (c = e, h = e + s; c < h; ++c)
    ((u = t[c]), (d = {}), (d[n.axis] = r || n.parse(a[c], c)), l.push(Lo(u, d, o, c)));
  return l;
}
function gs(i) {
...
function jr(i, t, e, s) {
  ...
  let { start: a, end: r, reverse: l, top: c, bottom: h } = Hr(i);
  (n === "middle" &&
    e &&
...
function Bn(i, t, e, s) {
  return (s ? ((i = $r(i, t, e)), (i = Wn(i, e, t))) : (i = Wn(i, t, e)), i);
}
function $r(i, t, e) {
...
var le = class extends it {
  ...
  parseObjectData(t, e, s, n) {
    let { iScale: o, vScale: a } = t,
      ...
      p;
    for (u = s, f = s + n; u < f; ++u)
      ((p = e[u]), (g = {}), (g[o.axis] = o.parse(_t(p, c), u)), d.push(Lo(_t(p, h), g, a, u)));
    return d;
  }
  updateRangeFromParsed(t, e, s, n) {
  ...
  updateElements(t, e, s, n) {
    ...
    for (let f = e; f < e + s; f++) {
      let g = this.getParsed(f),
        p = o || C(g[r.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
      ...
      (jr(x, v, b, a), Yr(x, v, h.ratio), this.updateElement(t[f], f, x, n));
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      let h = o ? this._getStackCount(t) : e.stackCount,
        d = n.barThickness === "flex" ? Wr(t, e, n, h * c) : Br(t, e, n, h * c),
        u =
...
var kt = class extends it {
  ...
  update(t) {
    let e = this.chart,
      ...
      l = Math.min(sn(this.options.cutout, r), 1),
      c = this._getRingWeight(this.index),
      { circumference: h, rotation: d } = this._getRotationExtents(),
      { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = Ur(d, h, l),
      m = (s.width - a) / u,
      b = (s.height - a) / f,
      ...
      if (l) {
        let { vScale: d } = n._cachedMeta,
          ...
          f = u
            .slice(0, h.lo + 1)
            .reverse()
            .findIndex((p) => !C(p[d.axis]));
        h.lo -= Math.max(0, f);
        let g = u.slice(h.hi).findIndex((p) => !C(p[d.axis]));
        h.hi += Math.max(0, g);
      }
      return h;
    }
...
function ms(i, t, e, s, n, o) {
  return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? Jr(i, t, e, n) : Zr(i, t, e, s, n, o);
}
...
function nl(i, t, e, s) {
  ...
  let r = Math.max(0, t.outerWidth - Hn(a, i, "left", "right")),
    l = Math.max(0, t.outerHeight - Hn(a, i, "top", "bottom")),
    c = r !== i.w,
    h = l !== i.h;
...
function Ie(i, t, e, s) {
  ...
  for (o = 0, a = i.length, c = 0; o < a; ++o) {
    ((r = i[o]), (l = r.box), l.update(r.width || t.w, r.height || t.h, al(r.horizontal, t)));
    let { same: d, other: u } = nl(t, e, r, s);
    ((c |= d && n.length), (h = h || u), l.fullSize || n.push(r));
  }
  return (c && Ie(n, t, e, s)) || h;
}
...
var J = {
    ...
    update(i, t, e, s) {
      if (!i) return;
      let n = G(i.options.layout.padding),
      ...
      (Ie(r.fullSize, f, d, g),
        Ie(l, f, d, g),
        Ie(c, f, d, g) && Ie(l, f, d, g),
        ol(f),
        jn(r.leftAndTop, f, d, g),
        (f.x += f.w),
        (f.y += f.h),
        jn(r.rightAndBottom, f, d, g),
        (i.chartArea = {
          left: f.left,
          top: f.top,
          right: f.left + f.w,
...
function gl(i, t) {
  (Ne.size || window.addEventListener("resize", Fo), Ne.set(i, t));
}
function pl(i) {
  (Ne.delete(i), Ne.size || window.removeEventListener("resize", Fo));
}
function ml(i, t, e) {
  let s = i.canvas,
    n = s && di(s);
...
var Ps = class extends Mi {
  acquireContext(t, e) {
    ...
    return s && s.canvas === t ? (ll(t, e), s) : null;
  }
  releaseContext(t) {
    let e = t.canvas;
    if (!e[_i]) return !1;
    ...
    ["height", "width"].forEach((o) => {
      let a = s[o];
      C(a) ? e.removeAttribute(o) : e.setAttribute(o, a);
    });
    let n = s.style || {};
    return (
  ...
  addEventListener(t, e, s) {
    ...
    let n = t.$proxies || (t.$proxies = {}),
      a = { attach: ul, detach: fl, resize: ml }[e] || bl;
    n[e] = a(t, e, s);
  }
  removeEventListener(t, e) {
    let s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    ((({ attach: bs, detach: bs, resize: bs })[e] || hl)(t, e, n), (s[e] = void 0));
  }
  getDevicePixelRatio() {
...
function _l(i, t) {
  let e = i.options.ticks,
    ...
    l = o[a - 1],
    c = [];
  if (a > n) return (kl(t, c, o, a / n), c);
  let h = vl(o, t, n);
  if (a > 0) {
    let d,
      u,
      f = a > 1 ? Math.round((l - r) / (a - 1)) : null;
    for (gi(t, c, h, C(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++)
      gi(t, c, h, o[d], o[d + 1]);
    return (gi(t, c, h, l, C(f) ? t.length : l + f), c);
  }
  return (gi(t, c, h), c);
}
function yl(i) {
...
var Sl = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
  Un = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e),
...
function Tl(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    ...
    } else e === "center" ? (g = (c.bottom + c.top) / 2 + p - t) : (g = Un(i, e, t));
    u = r - o;
  } else {
    if (T(e)) {
      let b = Object.keys(e)[0],
    ...
    } else e === "center" ? (f = (c.left + c.right) / 2 - m + t) : (f = Un(i, e, t));
...
var Xt = class i extends st {
    ...
    update(t, e, s) {
      ...
      (this.beforeUpdate(),
        ...
        this._dataLimitsCached ||
          ...
          (this._range = _n(this, o, n)),
          (this._dataLimitsCached = !0)),
        this.beforeBuildTicks(),
        (this.ticks = this.buildTicks() || []),
        this.afterBuildTicks());
      let l = r < this.ticks.length;
      (this._convertTicksToLabels(l ? Kn(this.ticks, r) : this.ticks),
        this.configure(),
        ...
        a.display &&
          ...
          ((this.ticks = _l(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    calculateLabelRotation() {
      ...
      ((r = t.offset ? this.maxWidth / s : f / (s - 1)),
        d + 6 > r &&
          ...
          (l = this.maxHeight - Te(t.grid) - e.padding - Gn(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (a = si(
            Math.min(
    ...
    _convertTicksToLabels(t) {
      ...
      let e, s;
      for (e = 0, s = t.length; e < s; e++) C(t[e].label) && (t.splice(e, 1), s--, e--);
      ...
      for (d = 0; d < e; d += l) {
        if (
          ...
          for (u = 0, f = g.length; u < f; ++u)
            ((_ = g[u]), !C(_) && !z(_) && ((v = ke(n, b.data, b.gc, v, _)), (y += x)));
    ...
    getPixelForDecimal(t) {
      ...
      return ln(this._alignToPixels ? At(this.chart, e, 0) : e);
    }
    ...
    _computeGridLineItems(t) {
      ...
      if (a === "top")
        ...
        ((x = b(this.top)), (A = t.top), (U = b(t.bottom) - m), (w = x + m), (P = this.top + u));
      else if (a === "left")
        ((x = b(this.right)),
          (k = this.right - u),
          (S = x - m),
        ...
        if (a === "center") x = b((t.top + t.bottom) / 2 + 0.5);
          ...
          let V = Object.keys(a)[0],
            j = a[V];
          x = b(this.chart.scales[V].getPixelForValue(j));
        }
        ((A = t.top), (U = t.bottom), (w = x + m), (P = w + u));
      } else if (e === "y") {
      ...
      let et = D(n.ticks.maxTicksLimit, d),
        E = Math.max(1, Math.ceil(d / et));
      for (v = 0; v < d; v += E) {
        let V = this.getContext(v),
          j = o.setContext(V),
          rt = r.setContext(V),
          q = j.lineWidth,
          Kt = j.color,
          ...
          ? ((_ = S),
            ...
            n === "top"
              ? c === "near" || p !== 0
                ? (L = -A * O + O / 2)
                : c === "center"
                  ? (L = -et.highest.height / 2 - V * O + O)
                  : (L = -et.highest.height + O / 2)
              : c === "near" || p !== 0
                ? (L = O / 2)
                : c === "center"
                  ? (L = et.highest.height / 2 - V * O)
                  : (L = et.highest.height - A * O),
            d && (L *= -1),
            p !== 0 && !E.showLabelBackdrop && (_ += (O / 2) * Math.sin(p)))
          : ((k = S), (L = ((1 - A) * O) / 2));
        let Ye;
        if (E.showLabelBackdrop) {
          let Gt = G(E.backdropPadding),
            be = et.heights[b],
            It = et.widths[b],
            xe = L - Gt.top,
            Et = 0 - Gt.left;
    ...
    drawBorder() {
      ...
      let r = n.setContext(this.getContext(0)).lineWidth,
        ...
        u;
      (this.isHorizontal()
        ? ((c = At(t, this.left, a) - a / 2), (h = At(t, this.right, r) + r / 2), (d = u = l))
        : ((d = At(t, this.top, a) - a / 2), (u = At(t, this.bottom, r) + r / 2), (c = h = l)),
        e.save(),
        (e.lineWidth = o.width),
    ...
    drawTitle() {
      ...
      e === "bottom" || e === "center" || T(e)
        ...
        : (l += a.top);
      let { titleX: c, titleY: h, maxWidth: d, rotation: u } = Tl(this, l, e, r);
      Ct(t, s.text, 0, 0, o, {
        color: s.color,
        maxWidth: d,
        rotation: u,
  ...
  pe = class {
    ...
    register(t) {
      let e = Object.getPrototypeOf(t),
        s;
      Il(e) && (s = this.register(e));
      let n = this.items,
        o = t.id,
        a = this.scope + "." + o;
      if (!o) throw new Error("class does not have id: " + t);
      return (
        o in n || ((n[o] = t), Ll(t, a, s), this.override && W.override(t.id, t.overrides)), a
      );
    }
    get(t) {
      return this.items[t];
    ...
    unregister(t) {
      let e = this.items,
        s = t.id,
        n = this.scope;
      (s in e && delete e[s], n && s in W[n] && (delete W[n][s], this.override && delete Ot[s]));
    }
  };
function Ll(i, t, e) {
  let s = Zt(Object.create(null), [e ? W.get(e) : {}, W.get(t), i.defaults]);
  (W.set(t, s),
    i.defaultRoutes && Rl(t, i.defaultRoutes),
...
function Cs(i, ...t) {
  if (qn(i)) return i;
  for (let e of t) {
    let s = e.axis || Nl(e.position) || (i.length > 1 && qn(i[0].toLowerCase()));
    if (s) return s;
  }
  throw new Error(
...
function Hl(i, t) {
  if (t.data && t.data.datasets) {
    ...
    if (e.length) return Jn(i, "x", e[0]) || Jn(i, "y", e[0]);
  }
  return {};
}
function jl(i, t) {
  ...
  return (
    Object.keys(s).forEach((a) => {
      ...
      let l = Cs(a, r, Hl(a, i), W.scales[r.type]),
        c = Vl(l, n),
        h = e.scales || {};
...
function pi(i, t) {
  let e = Zn.get(i);
  return (e || ((e = t()), Zn.set(i, e), Wo.add(e)), e);
}
var Le = (i, t, e) => {
    let s = _t(t, e);
    s !== void 0 && i.add(s);
  ...
  Ts = class {
    constructor(t) {
      ((this._config = $l(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map()));
    }
    get platform() {
    ...
    chartOptionScopes() {
      ...
      return [t, Ot[e] || {}, W.datasets[e] || {}, { type: e }, W, ai];
    }
    resolveNamedOptions(t, e, s, n = [""]) {
      let o = { $shared: !0 },
        { resolver: a, subPrefixes: r } = Qn(this._resolverCache, t, n),
        l = a;
      if (Ul(a, e)) {
    ...
    createResolver(t, e, s = [""], n) {
      let { resolver: o } = Qn(this._resolverCache, t, s);
...
var Yl = (i) => T(i) && Object.getOwnPropertyNames(i).some((t) => bt(i[t]));
function Ul(i, t) {
  ...
  for (let n of t) {
    let o = e(n),
      a = s(n),
      r = (a || o) && i[n];
    if ((o && (bt(r) || Yl(r))) || (a && z(r))) return !0;
  }
  return !1;
}
var Xl = "4.5.1",
  Kl = ["top", "bottom", "left", "right", "chartArea"];
function to(i, t) {
...
var at = class {
  ...
  constructor(t, e) {
    ...
    ((this.platform = new (s.platform || xl(n))()), this.platform.updateConfig(s));
    ...
    if (
      ...
      (this.$context = void 0),
      (this._doResize = fn((d) => this.update(d), a.resizeDelay || 0)),
      (this._dataChanges = []),
      (yi[this.id] = this),
      !r || !l)
    ) {
    ...
    (vt.listen(this, "complete", io),
      vt.listen(this, "progress", Gl),
      this._initialize(),
    ...
    (e &&
      ...
      I(o, (a) => {
        let r = a.options,
          ...
          c = Cs(l, r),
          h = D(r.type, a.dtype);
        ((r.position === void 0 || to(r.position, c) !== to(a.dposition)) &&
    ...
    for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
      ...
      if (
        ...
        let l = gt.getController(r),
          { datasetElementType: c, dataElementType: h } = W.datasets[r];
        (Object.assign(l, {
  ...
  _handleEvent(t, e, s) {
    ...
    let h = !we(r, n);
    return (
      (h || e) && ((this._active = r), this._updateHoverStyles(r, n, e)), (this._lastEvent = c), h
    );
  }
...
(M(at, "defaults", W),
  ...
  M(at, "getChart", so));
function no() {
  return I(at.instances, (i) => i._plugins.invalidate());
}
function Zl(i, t, e) {
...
function ec(i, t, e, s) {
  let n = tc(i.options.borderRadius),
    o = (e - t) / 2,
    a = Math.min(o, (s * t) / 2),
    r = (l) => {
...
function wi(i, t, e, s, n, o) {
  ...
  let p = Math.max(0.001, g * d - e / R) / d,
    ...
    b = l + m + f,
    x = n - m - f,
    { outerStart: v, outerEnd: y, innerStart: _, innerEnd: k } = ec(t, u, d, x - b),
    w = d - v,
    S = d - y,
    P = b + v / w,
    O = x - y / S,
  ...
  if ((i.beginPath(), o)) {
    ...
    if ((i.arc(a, r, d, P, E), i.arc(a, r, d, E, O), y > 0)) {
      let q = re(S, O, a, r);
      i.arc(q.x, q.y, y, O, x + H);
    }
    let V = re(L, x, a, r);
    if ((i.lineTo(V.x, V.y), k > 0)) {
      let q = re(L, et, a, r);
      i.arc(q.x, q.y, k, x + H, et + Math.PI);
    }
    let j = (x - k / u + (b + _ / u)) / 2;
    if ((i.arc(a, r, u, x - k / u, j, !0), i.arc(a, r, u, j, b + _ / u, !0), _ > 0)) {
      let q = re(A, U, a, r);
      i.arc(q.x, q.y, _, U + Math.PI, b - H);
    }
    let rt = re(w, b, a, r);
    if ((i.lineTo(rt.x, rt.y), v > 0)) {
      let q = re(w, P, a, r);
      i.arc(q.x, q.y, v, b - H, P);
    }
  } else {
    i.moveTo(a, r);
    let E = Math.cos(P) * d + a,
      V = Math.sin(P) * d + r;
    i.lineTo(E, V);
...
function sc(i, t, e, s, n) {
  ...
  (g && Ql(i, t, p),
    l.selfJoin && p - a >= R && f === 0 && h !== "miter" && Zl(i, t, p),
...
function oc(i) {
  return i.stepped ? bn : i.tension || i.cubicInterpolationMode === "monotone" ? xn : nc;
}
function Ho(i, t, e = {}) {
  let s = i.length,
...
function ac(i, t, e, s) {
  let { points: n, options: o } = t,
    { count: a, start: r, loop: l, ilen: c } = Ho(n, e, s),
    h = oc(o),
...
function rc(i, t, e, s) {
  let n = t.points,
    { count: o, start: a, ilen: r } = Ho(n, e, s),
...
function lc(i) {
  return i.stepped ? Dn : i.tension || i.cubicInterpolationMode === "monotone" ? On : Pt;
}
function cc(i, t, e, s) {
  let n = t._path;
...
var dc = typeof Path2D == "function";
function uc(i, t, e, s) {
  dc && !t.options.segment ? cc(i, t, e, s) : hc(i, t, e, s);
}
var pt = class extends st {
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      (wn(this._points, s, t, n, e), (this._pointsUpdated = !0));
    }
  }
  set points(t) {
  ...
  draw(t, e, s, n) {
    let o = this.options || {};
    ((this.points || []).length && o.borderWidth && (t.save(), uc(t, this, s, n), t.restore()),
...
var fe = class extends st {
  ...
  inXRange(e, s) {
    return oo(this, e, "x", s);
  }
  inYRange(e, s) {
    return oo(this, e, "y", s);
  }
  getCenterPoint(e) {
...
var xc = Object.freeze({
  ...
  ao = Rs.map((i) => i.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function $o(i) {
  return Rs[i % Rs.length];
}
function Yo(i) {
  return ao[i % ao.length];
}
function _c(i, t) {
  return ((i.borderColor = $o(t)), (i.backgroundColor = Yo(t)), ++t);
}
function yc(i, t) {
...
function Mc(i) {
  ...
  return (e, s) => {
    ...
    n instanceof kt ? (t = yc(e, t)) : n instanceof Yt ? (t = vc(e, t)) : n && (t = _c(e, t));
  };
}
function ro(i) {
  let t;
...
function Cc(i, t, e) {
  ...
  for (let r of s) {
    ...
    let d = cs(t, h);
    for (let u of d) {
      let f = Is(e, o[u.start], o[u.end], u.loop),
        g = ls(r, n, f);
      for (let p of g)
        a.push({
          source: p,
          target: u,
          start: { [e]: co(h, f, "start", Math.max) },
          end: { [e]: co(h, f, "end", Math.min) },
        });
    }
  }
  return a;
...
function zc(i) {
  let t = i.options,
    ...
    s = D(e && e.target, e);
  return (
    s === void 0 && (s = !!t.backgroundColor), s === !1 || s === null ? !1 : s === !0 ? "origin" : s
  );
}
function Bc(i) {
  let { scale: t, index: e, line: s } = i,
    ...
    a = s.points,
    r = Wc(t, e);
  r.push(Xo({ x: null, y: t.bottom }, s));
  for (let l = 0; l < o.length; l++) {
    let c = o[l];
    for (let h = c.start; h <= c.end; h++) Vc(n, a[h], r);
  }
...
function Vc(i, t, e) {
  ...
  for (let n = 0; n < e.length; n++) {
    let o = e[n],
      { first: a, last: r, point: l } = Nc(o, t, "x");
    if (!(!l || (a && r))) {
      if (a) s.unshift(l);
...
function Hc(i) {
  ...
  if (N(e)) return jc(t, e);
  if (e === "stack") return Bc(i);
  if (e === "shape") return !0;
  let n = $c(i);
  return n instanceof Si ? n : Xo(n, s);
}
function jc(i, t) {
...
function $c(i) {
  return (i.scale || {}).getPointPositionForValue ? Uc(i) : Yc(i);
}
function Yc(i) {
...
function ys(i, t, e) {
  ...
  s &&
    a.points.length &&
    (Pe(i, e),
    Xc(i, { line: a, target: s, above: u, below: f, area: e, scale: r, axis: l, clip: p }),
    De(i));
}
function Xc(i, t) {
...
function vs(i, t) {
  ...
  for (let { source: c, target: h, start: d, end: u } of l) {
    let { style: { backgroundColor: f = o } = {} } = c,
      g = s !== !0;
    (i.save(), (i.fillStyle = f), Kc(i, a, r, g && Is(n, d, u)), i.beginPath());
    let p = !!e.pathSegment(i, c),
      m;
    if (g) {
      p ? i.closePath() : go(i, s, u, n);
...
var Gc = {
    ...
    afterDatasetsUpdate(i, t, e) {
      ...
      for (a = 0; a < s; ++a)
        ((o = i.getDatasetMeta(a)),
          ...
          n.push(l));
      for (a = 0; a < s; ++a)
        ((l = n[a]), !(!l || l.fill === !1) && (l.fill = Lc(n, a, e.propagate)));
    },
    beforeDraw(i, t, e) {
    ...
    beforeDatasetsDraw(i, t, e) {
      ...
      for (let n = s.length - 1; n >= 0; --n) {
        let o = s[n].$filler;
        ho(o) && ys(i.ctx, o, i.chartArea);
      }
    },
    beforeDatasetDraw(i, t, e) {
      let s = t.meta.$filler;
      !ho(s) || e.drawTime !== "beforeDatasetDraw" || ys(i.ctx, s, i.chartArea);
    },
  ...
  Pi = class extends st {
    ...
    fit() {
      ...
      let s = t.labels,
        ...
        { boxWidth: r, itemHeight: l } = po(s, o),
        c,
        h;
      ((e.font = n.string),
        this.isHorizontal()
    ...
    _fitCols(t, e, s, n) {
      ...
      return (
        this.legendItems.forEach((m, b) => {
          let { itemWidth: x, itemHeight: v } = Jc(s, e, o, m, n);
          (b > 0 &&
            f + v + 2 * r > h &&
    ...
    _draw() {
      ...
      (this.drawTitle(),
        ...
        (n.lineWidth = 0.5),
        (n.font = c.string));
      let { boxWidth: g, boxHeight: p, itemHeight: m } = po(a, d),
        b = function (k, w, S) {
          ...
          if (
            ...
            let O = {
              ...
              A = l.xPlus(k, g / 2),
              L = w + u;
            Zi(n, O, A, L, a.pointStyleWidth && g);
          } else {
      ...
      (this.legendItems.forEach((k, w) => {
        ...
        (l.setWidth(this.width),
          v
            ? w > 0 &&
              A + O + h > this.right &&
              ((L = f.y += _), f.line++, (A = f.x = K(o, this.left + h, this.right - s[f.line])))
            : w > 0 &&
              L + _ > this.bottom &&
        ...
        let U = l.x(A);
        if ((b(U, L, k), (A = gn(P, A + g + u, v ? A + O : this.right, t.rtl)), x(l.x(A), L, k), v))
          f.x += O + h;
...
function Qc(i, t, e) {
  let s = i;
  return (typeof t.text != "string" && (s = Ko(t, e)), s);
}
function Ko(i, t) {
...
function mo(i, t) {
  ...
  return (
    ...
    I(i.title, v),
    (e.font = l.string),
    I(i.beforeBody.concat(i.afterBody), v),
...
function bo(i, t, e) {
  let s = e.yAlign || t.yAlign || ah(i, e);
  return { xAlign: e.xAlign || t.xAlign || lh(i, t, e, s), yAlign: s };
}
function ch(i, t) {
  let { x: e, width: s } = i;
...
function Q(i, t, e, s) {
  let n = i[t].call(e, s);
  return typeof n > "u" ? Go[t].call(e, s) : n;
}
var Ve = class extends st {
  ...
  getBeforeBody(t, e) {
    return _o(Q(e.callbacks, "beforeBody", this, t));
  }
  getBody(t, e) {
    let { callbacks: s } = e,
      n = [];
  ...
  getAfterBody(t, e) {
    return _o(Q(e.callbacks, "afterBody", this, t));
  }
  getFooter(t, e) {
    let { callbacks: s } = e,
  ...
  update(t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
      ...
      let l = (this._size = mo(this, s)),
        c = Object.assign({}, r, l),
        h = bo(this.chart, s, c),
        d = xo(s, c, h, this.chart);
...
function ph(i, t, e, s) {
  let n = i.indexOf(t);
  if (n === -1) return gh(i, t, e, s);
  let o = i.lastIndexOf(t);
  return n !== o ? e : n;
}
var mh = (i, t) => (i === null ? null : Y(Math.round(i), 0, t));
function vo(i) {
...
var Fe = class extends Xt {
  ...
  parse(t, e) {
    ...
    let s = this.getLabels();
    return (
      (e = isFinite(e) && s[e] === t ? e : ph(s, t, D(e, t), this._addedLabels)),
      mh(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
(M(Fe, "id", "category"), M(Fe, "defaults", { ticks: { callback: vo } }));
function bh(i, t) {
  let e = [],
    {
      bounds: n,
  ...
  ((P = Math.ceil(m / _) - Math.floor(p / _)),
    P > g && (_ = Wi((P * _) / g / f) * f),
    C(l) || ((k = Math.pow(10, l)), (_ = Math.ceil(_ * k) / k)),
    n === "ticks" ? ((w = Math.floor(p / _) * _), (S = Math.ceil(m / _) * _)) : ((w = p), (S = m)),
    b && x && o && rn((r - a) / o, _ / 1e3)
  ...
  ((k = Math.pow(10, C(l) ? O : l)), (w = Math.round(w * k) / k), (S = Math.round(S * k) / k));
  let A = 0;
  for (
    b &&
    (u && w !== a
      ? (e.push({ value: a }),
        w < a && A++,
        ie(Math.round((w + A * _) * k) / k, a, Mo(a, y, i)) && A++)
      : w < a && A++);
    A < P;
    ++A
  ) {
    let L = Math.round((w + A * _) * k) / k;
    if (x && L > r) break;
    e.push({ value: L });
  }
  return (
    x && u && S !== r
      ? e.length && ie(e[e.length - 1].value, r, Mo(r, y, i))
...
function Mo(i, t, { horizontal: e, minRotation: s }) {
  let n = ot(s),
...
var me = class extends Xt {
    ...
    buildTicks() {
      ...
      let n = {
        ...
        a = bh(n, o);
      return (
        t.bounds === "ticks" && Vi(a, this, "value"),
        t.reverse
...
function _h(i, { min: t, max: e }) {
  ...
  for (; u < e; )
    (s.push({ value: u, major: ko(u), significand: d }),
      d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
      d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
      (u = Math.round((l + h + d * Math.pow(10, o)) * a) / a));
  let f = Z(i.max, u);
  return (s.push({ value: f, major: ko(f), significand: d }), s);
}
var Be = class extends Xt {
  ...
  buildTicks() {
    let t = this.options,
      ...
      s = _h(e, this);
    return (
      t.bounds === "ticks" && Vi(s, this, "value"),
      t.reverse
...
function yh(i, t, e) {
  return ((e = z(e) ? e : [e]), { w: mn(i, t.string, e), h: e.length * t.lineHeight });
}
...
function vh(i) {
  ...
  for (let l = 0; l < o; l++) {
    ...
    let h = i.getPointPosition(l, i.drawingArea + n[l], r),
      d = $(c.font),
      u = yh(i.ctx, d, i._pointLabels[l]);
    s[l] = u;
    let f = X(i.getIndexAngle(l) + r),
      g = Math.round(si(f)),
      p = So(g, h.x, u.w, 0, 180),
      m = So(g, h.y, u.h, 90, 270);
    Mh(e, t, f, p, m);
  }
  (i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
    (i._pointLabelItems = Sh(i, s, n)));
}
...
function Sh(i, t, e) {
  let s = [],
    ...
    l = { extra: Es(o) / 2, additionalAngle: a ? R / n : 0 },
    c;
  for (let h = 0; h < n; h++) {
...
var $t = class extends me {
  ...
  setDimensions() {
    let t = (this._padding = G(Es(this.options) / 2)),
  ...
  drawGrid() {
    let t = this.ctx,
      ...
      c;
    if (
      (e.pointLabels.display && Ch(this, a),
      n.display &&
...
function Do(i, t) {
  ...
  return (
    ...
    a === null
      ? null
      : (n &&
          (a = n === "week" && (Wt(o) || o === !0) ? e.startOf(a, "isoWeek", o) : e.startOf(a, n)),
        +a)
  );
}
function Oo(i, t, e, s) {
...
var Ut = class extends Xt {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (s.autoSkip
          ? Oo(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
          : Rh(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : Ih(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
  ...
  _generate() {
    let t = this._adapter,
      ...
      n = this.options,
      o = n.time,
      a = o.unit || Oo(o.minUnit, e, s, this._getLabelCapacity(e)),
    ...
    for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) Ao(h, u, g);
    return (
      (u === s || n.bounds === "ticks" || f === 1) && Ao(h, u, g),
      Object.keys(h)
        .sort(Po)
        .map((p) => +p)
    );
  ...
  getLabelTimestamps() {
    ...
    for (e = 0, s = n.length; e < s; ++e) t.push(Do(this, n[e]));
...
(M(We, "id", "timeseries"), M(We, "defaults", Ut.defaults));
...
function zs(i) {
  return i >= 80 ? "#10b981" : i >= 60 ? "#84cc16" : i >= 40 ? "#f59e0b" : "#ef4444";
}
function Wh(i) {
  return {
    payload: i,
    ...
    computeAttitude() {
      let t = this.payload?.scorecard,
        e = t?.roll?.value ?? null,
        s = t?.pitch?.value ?? null;
      if (e === null && s === null) return null;
      let n = e ?? 0,
        o = s ?? 0,
        a = Math.max(-30, Math.min(30, n)),
        l = Math.max(-30, Math.min(30, o * 3));
      return {
        roll: n,
        pitch: o,
        rollRotation: a,
        pitchOffset: l,
        rollScore: t?.roll?.score ?? 0,
        pitchScore: t?.pitch?.score ?? 0,
      };
    },
    renderScorecard() {
      let t = this.payload?.scorecard;
      if (!t) return;
      let e = this.$refs?.scorecard;
      if (!e) return;
      let s = Object.keys(ta),
        n = s.map((l) => t[l]?.score ?? 0),
        o = s.map((l) => ta[l]),
        a = Math.min(...n),
        r = zs(a);
            ...
            datasets: [
              {
                ...
                borderColor: r,
                borderWidth: 2,
                pointBackgroundColor: n.map((l) => zs(l)),
              ...
              tooltip: {
                callbacks: {
                  label: (l) => {
                    let c = s[l.dataIndex],
                      h = t[c]?.value,
                      d = h == null ? "\u2014" : typeof h == "number" ? h.toFixed(2) : h;
                    return ` ${l.parsed.toFixed(0)} / 100 (raw: ${d})`;
                  },
                },
              },
            },
    ...
    computeMarker(t) {
      ...
      if (!e) return null;
      let s = e.centerline_offset ?? 0,
        n = e.heading_deviation ?? 0,
        a = Math.max(-Fs, Math.min(Fs, s)) / Fs,
        r = zh + a * (ia / 2 - 4),
        l = t === "arrival" ? 55 : 75,
        c = Math.max(-Qo, Math.min(Qo, n * Bh)),
        h = this.payload?.scorecard?.centerline?.score ?? 0;
      return { x: l, y: r, rotation: c, color: zs(h), offset: s, heading: n, runway: e.runway };
    },
  };
}
