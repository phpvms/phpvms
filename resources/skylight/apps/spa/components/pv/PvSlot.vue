...
import { usePvContext } from '@/composables/usePvSlot'
import { entriesForSlot, resolveEntryProps, type SlotEntry } from '@/lib/registry'
...
<template>
  <template
    ...
    :key="r.entry.component + '-' + r.entry.order + '-' + i"
  >
