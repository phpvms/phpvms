  ...
  <section class="frame" :class="{ editing }">
    <header class="head">
      <span v-if="editing" class="handle" aria-label="Drag to reorder" title="Drag">
        <svg viewBox="0 0 24 24" class="ic" fill="currentColor"><circle cx="9" cy="6" r="1.4"/><circle cx="15" cy="6" r="1.4"/><circle cx="9" cy="12" r="1.4"/><circle cx="15" cy="12" r="1.4"/><circle cx="9" cy="18" r="1.4"/><circle cx="15" cy="18" r="1.4"/></svg>
      </span>
      ...
      <button
        ...
        @click="$emit('remove')"
      >
        <svg viewBox="0 0 24 24" class="ic" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg>
      </button>
    </header>
    <div class="body">
      <slot />
