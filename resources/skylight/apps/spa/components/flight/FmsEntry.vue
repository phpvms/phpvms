...
<template>
  <form class="fms" role="search" @submit.prevent="submit">
    <div class="grp">
      ...
      <input v-model="from" class="in" maxlength="4" spellcheck="false" autocomplete="off" aria-label="Departure ICAO" />
    </div>
    <span class="fms-arrow" aria-hidden="true">▸</span>
    <div class="grp">
      <span class="lbl">To</span>
      <input v-model="to" class="in" maxlength="4" placeholder="____" spellcheck="false" autocomplete="off" aria-label="Destination ICAO" />
    </div>
