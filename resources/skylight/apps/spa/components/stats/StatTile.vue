...
const props = withDefaults(
  defineProps<{ label: string; value: string | number; mono?: boolean; small?: boolean; accent?: Accent }>(),
  { mono: false, small: false, accent: 'ink' },
)

const accentVar = computed(() => (props.accent === 'ink' ? 'var(--pv-ink)' : `var(--pv-${props.accent})`))
</script>
