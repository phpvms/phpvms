...
<li>
  ...
  <div class="collapse" id="operations_menu" aria-expanded="true">
    <ul class="nav">
      ...
      @can('view_any_flight')
        <li><a href="{{ \App\Filament\Resources\FlightResource::getUrl() }}"><i class="pe-7s-vector"></i>flights</a>
        </li>
      @endcan
  ...
  <div class="collapse" id="config_menu" aria-expanded="true">
    <ul class="nav">
      @can('view_any_airline')
        <li><a href="{{ \App\Filament\Resources\AirlineResource::getUrl() }}"><i class="pe-7s-paper-plane"></i>airlines</a>
        </li>
      @endcan
      ...
      @can('view_any_airport')
        <li><a href="{{ \App\Filament\Resources\AirportResource::getUrl() }}"><i
              class="pe-7s-map-marker"></i>airports</a></li>
      @endcan

      @can('view_any_expense')
        <li><a href="{{ \App\Filament\Resources\ExpenseResource::getUrl() }}"><i class="pe-7s-cash"></i>expenses</a>
        </li>
      @endcan
      ...
      @can('view_any_award')
        <li><a href="{!! \App\Filament\Resources\AwardResource::getUrl() !!}"><i class="pe-7s-diamond"></i>awards</a>
        </li>
      @endcan

      @can('view_any_role')
        <li><a href="{!! \BezhanSalleh\FilamentShield\Resources\RoleResource::getUrl() !!}"><i
      ...
      <li><a href="{{ \App\Filament\Resources\ActivityLogResource::getUrl() }}"><i class="pe-7s-news-paper"></i>activities</a>
      </li>
