              ...
              <div class="row">
                ...
                <div class="col-4 text-center">
                  <div><p class="small text-uppercase pb-sm-0 mb-sm-1">Est. Enroute Time</p>
                    <p class="border border-dark rounded p-1 small text-monospace">
                      {{ \Carbon\Carbon::createFromFormat('H:i:s', $simbrief->ofp->times->est_time_enroute)->format('H\h i\m') }}
                    </p>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div><p class="small text-uppercase pb-sm-0 mb-sm-1">Departure METAR</p>
                    <p
                      class="border border-dark rounded p-1 small text-monospace">{{ $simbrief->ofp->weather->orig_metar }}</p>
                  </div>
                  <div><p class="small text-uppercase pb-sm-0 mb-sm-1">Departure TAF</p>
                    <p
                      class="border border-dark rounded p-1 small text-monospace">{{ $simbrief->ofp->weather->orig_taf }}</p>
                  </div>
                  <hr/>
                  <div><p class="small text-uppercase pb-sm-0 mb-sm-1">Destination METAR</p>
                    <p
                      class="border border-dark rounded p-1 small text-monospace">{{ $simbrief->ofp->weather->dest_metar }}</p>
                  </div>
            ...
            <div class="form-container-body">
              <div class="row">
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->ofp->prefile->ivao->link }}" target="_blank" class="btn btn-info">File > IVAO</a>
                </div>
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->ofp->prefile->vatsim->link }}" target="_blank" class="btn btn-info">File > VATSIM</a>
                </div>
                <div class="col-3" align="center">
                  <a href="{{ $simbrief->ofp->prefile->poscon->link }}" target="_blank" class="btn btn-info">File > POSCON</a>
                </div>
                <div class="col-3" align="center">
                  <a
                    href="http://skyvector.com/?chart=304&amp;fpl={{ $simbrief->ofp->origin->icao_code}} {{ $simbrief->ofp->general->route }} {{ $simbrief->ofp->destination->icao_code}}"
