(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".svw[data-v-100edc5f]{display:flex;flex-direction:column;gap:10px}.svw-head[data-v-100edc5f]{display:flex;align-items:baseline;justify-content:space-between}.svw-label[data-v-100edc5f]{font-size:13px;font-weight:500;color:var(--pv-accent, #4f8cff)}.svw-refresh[data-v-100edc5f]{background:none;border:none;cursor:pointer;padding:0 2px;font-size:13px;line-height:1;color:var(--pv-ink-dim, #8a94a6)}.svw-refresh[data-v-100edc5f]:hover{color:var(--pv-accent, #4f8cff)}.svw-loading[data-v-100edc5f]{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--pv-ink-dim, #8a94a6)}.svw-spin[data-v-100edc5f]{width:12px;height:12px;border:2px solid var(--pv-line, #2a2f3a);border-top-color:var(--pv-accent, #4f8cff);border-radius:50%;animation:svw-spin-100edc5f .8s linear infinite}@keyframes svw-spin-100edc5f{to{transform:rotate(360deg)}}.svw-rows[data-v-100edc5f]{display:flex;flex-direction:column;gap:4px;margin:0}.svw-rows div[data-v-100edc5f]{display:flex;gap:10px}.svw-rows dt[data-v-100edc5f]{font-size:11px;text-transform:uppercase;letter-spacing:.05em;min-width:62px;color:var(--pv-ink-faint, #6b7280)}.svw-rows dd[data-v-100edc5f]{margin:0;font-size:13px;color:var(--pv-ink, #e6e9ef)}.mono[data-v-100edc5f]{font-family:var(--pv-font-mono, ui-monospace, monospace)}.svw-err[data-v-100edc5f]{font-size:12px;padding:8px 10px;color:var(--pv-slot-error-text, #ffb4b4);background:var(--pv-slot-error-bg, rgba(255, 80, 80, .08));border:1px solid var(--pv-slot-error-border, rgba(255, 80, 80, .3));border-radius:var(--pv-radius-sm, 6px)}")),document.head.appendChild(e)}}catch(a){console.error("vite-plugin-css-injected-by-js",a)}})();
...
const _ = { class: "svw" }, f = { class: "svw-head" }, w = { class: "svw-label" }, b = {
  ...
  for (const [a, r] of u)
    s[a] = r;
  return s;
}, M = /* @__PURE__ */ V(E, [["__scopeId", "data-v-100edc5f"]]);
export {
  M as default
};
