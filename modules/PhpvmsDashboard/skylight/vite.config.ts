...
// modules/PhpvmsDashboard/skylight/, so the module root is one level up.
 ...
 * The 'weather' key → modules/PhpvmsDashboard/public/widgets/weather.js, which
...
export default defineAddonWidgetConfig({
  addonDir,
  entries: {
    weather: resolve(addonDir, 'skylight/WeatherWidget.vue'),
  },
})
