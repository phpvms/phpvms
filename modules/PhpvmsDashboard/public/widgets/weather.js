(function(){"use strict";try{if(typeof document<"u"){var a=document.createElement("style");a.appendChild(document.createTextNode(".wx[data-v-0b862cb0]{display:flex;flex-direction:column;gap:10px}.wxid[data-v-0b862cb0]{display:flex;align-items:baseline;justify-content:space-between}.micro[data-v-0b862cb0]{font-size:11px;color:var(--pv-ink-faint, #6b7280);text-transform:uppercase;letter-spacing:.05em}.code[data-v-0b862cb0]{font-family:var(--pv-font-mono, ui-monospace, monospace);font-size:14px;color:var(--pv-accent, #4f8cff);font-weight:500}.loading[data-v-0b862cb0]{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--pv-ink-dim, #8a94a6)}.spin[data-v-0b862cb0]{width:12px;height:12px;border:2px solid var(--pv-line, #2a2f3a);border-top-color:var(--pv-accent, #4f8cff);border-radius:50%;animation:spin-0b862cb0 .8s linear infinite}@keyframes spin-0b862cb0{to{transform:rotate(360deg)}}.rows[data-v-0b862cb0]{display:flex;flex-direction:column;gap:4px;margin:0}.rows div[data-v-0b862cb0]{display:flex;gap:10px}.rows dt[data-v-0b862cb0]{font-size:11px;color:var(--pv-ink-faint, #6b7280);text-transform:uppercase;letter-spacing:.05em;min-width:46px}.rows dd[data-v-0b862cb0]{margin:0;font-size:13px;color:var(--pv-ink, #e6e9ef)}.metar[data-v-0b862cb0]{font-family:var(--pv-font-mono, ui-monospace, monospace);font-size:11px;color:var(--pv-ink-dim, #8a94a6);background:var(--pv-panel-inset, rgba(0, 0, 0, .04));border-radius:var(--pv-radius-sm, 6px);padding:8px 10px;white-space:pre-wrap;word-break:break-word}.err[data-v-0b862cb0]{font-size:12px;color:var(--pv-slot-error-text, #ffb4b4);background:var(--pv-slot-error-bg, rgba(255, 80, 80, .08));border:1px solid var(--pv-slot-error-border, rgba(255, 80, 80, .3));border-radius:var(--pv-radius-sm, 6px);padding:8px 10px}")),document.head.appendChild(a)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();
...
const w = { class: "wx" }, y = { class: "wxid" }, b = { class: "code tnum" }, x = {
  ...
  for (const [a, c] of d)
    t[a] = c;
  return t;
}, U = /* @__PURE__ */ O(M, [["__scopeId", "data-v-0b862cb0"]]);
export {
  U as default
};
