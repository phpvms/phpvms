...
From the theme workspace (`resources/js/apps/frontend-ui/`):
...
```
modules/phpvms-sample-vue-widget/public/widgets/sample.js
```

To build just this one addon directly:

```bash
# from resources/js/apps/frontend-ui/
...
```bash
grep 'from "vue"' modules/phpvms-sample-vue-widget/public/widgets/sample.js
```
...
`resources/js/apps/frontend-ui/apps/spa/types/generated.d.ts`, exposing the ambient global
