...
import { defineAddonWidgetConfig } from '../../../resources/js/apps/fe-vue/addon-build/widget-preset'

// Module root = the dir that contains `public/`. This file lives in
// modules/phpvms-sample-vue-widget/ui/, so the module root is one level up.
const addonDir = resolve(fileURLToPath(new URL('.', import.meta.url)), '..')

/**
 * DISCOVERY CONVENTION:
 * The core theme build (`pnpm build` in resources/js/apps/fe-vue, via
 ...
 * The 'sample' key → modules/phpvms-sample-vue-widget/public/widgets/sample.js, which is
