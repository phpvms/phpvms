 ...
 * on `<svg`), so ImageUploadService must store it verbatim rather than attempt
 * a conversion. The logo field explicitly accepts image/svg+xml.
 */
it('stores an uploaded SVG logo untouched', function (): void {
    $airline = Airline::factory()->create(['icao' => 'ABC', 'iata' => 'AB', 'country' => 'us', 'logo' => null, 'logo_hash' => null]);
