...
class Money implements Stringable
{
     ...
     */
    public static function create($amount): MoneyBase
    {
     ...
     * Alias of getAmount()
     */
    public function toAmount(): float|int
    {
    ...
    public function getInstance(): MoneyBase
    {
        return $this->money;
    }
     ...
     * @throws InvalidArgumentException
     */
    public function multiply(int|float $amount): static
    {
