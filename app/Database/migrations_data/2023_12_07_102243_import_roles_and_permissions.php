    ...
    public function up(): void
    {
        ...
        $permissions = [
            ...
            'pireps' => [
                ...
                'update_pirepfield',
                'restore_pirepfield',
                'restore_any_pirepfield',
                'replicate_pirepfield',
                'reorder_pirepfield',
                'delete_pirepfield',
                'delete_any_pirepfield',
                'force_delete_pirepfield',
                'force_delete_any_pirepfield',
            ],
            'ranks' => [
                'view_rank',
                'view_any_rank',
            ...
            'users' => [
                ...
                'update_userfield',
                'restore_userfield',
                'restore_any_userfield',
                'replicate_userfield',
                'reorder_userfield',
                'delete_userfield',
                'delete_any_userfield',
                'force_delete_userfield',
                'force_delete_any_userfield',
            ],
        ];
